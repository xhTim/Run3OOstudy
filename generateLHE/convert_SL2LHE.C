...
void convert_SL2LHE(string infilename = "output_all/slight_CohPsi2S_4Feeddown_0001.tx", string outfilename = "starlight_LHEtest", double beamE1 = 3400, double beamE2 = 3400) //makeEventsFile
{
    char ofName[100];
